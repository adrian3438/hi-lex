...
export default function Modeling4({language}: Props) {
    ...
    return (
      <>
          <Canvas className="model-canvas">
              ...
              <>
                  <Html position={[0, 0.5, 0.12]} distanceFactor={5}>
                      <div
                  ...
                  <Html position={[0.17, 0, -0.1]} distanceFactor={5}>
                      <div
                        className="model-detail-button"
                        style={{background: '#00E5FF', padding: '2.5px', borderRadius: '2.5px', pointerEvents: 'auto', cursor: 'pointer',}}
                  ...
                  <Html position={[0, -0.45, 0.12]} distanceFactor={5}>
                      <div
                        className="model-detail-button"
                        style={{background: '#00E5FF', padding: '2.5px', borderRadius: '2.5px', pointerEvents: 'auto', cursor: 'pointer',}}
          ...
          <div className="features col-md-5">
              ...
              {buttonIndex === 1 && (
                <div className="features-01">
                    <div className="video-area">
                        <video src="/video/power-cinching-latch/power-cinching-latch-02.mp4" autoPlay muted loop/>
                    </div>
                    <div className="text-area">
                        <h2>{language?.e_latch_08}</h2>
                    </div>
                    <button className="detail-close" onClick={() => setButtonIndex(100)}/>
                </div>
              )}
              {buttonIndex === 2 && (
                <div className="features-01">
                    <div className="video-area">
                        <video src="/video/power-cinching-latch/power-cinching-latch-03.mp4" autoPlay muted loop/>
                    </div>
                    <div className="text-area">
                        <h2>{language?.e_latch_09}</h2>
                    </div>
                    <button className="detail-close" onClick={() => setButtonIndex(100)}/>
                </div>
              )}
