...
export default async function ProcurementPage({searchParams : {lang}} : any) {
                ...
                <div className="career-container">
                    ...
                    <div className="position-list">
                        <ul>
                            ...
                            <li className="active"><Link href="/career/position/procurement">{language?.position_01_08}</Link></li>
                            <li><Link href="/career/position/management">{language?.position_01_09}</Link></li>
                        </ul>
                    </div>
                    <div className="position-content procurement">
                        <p><Image src="/images/sub/career/position/position-05.jpg" alt="" width={1420} height={430}/></p><br/><br/>
